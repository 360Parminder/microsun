...
const Project=({image,title,content})=>{
    return(
        <div className='w-[30vw] flex flex-col items-center text-center bg-[#4e46e578] rounded-md p-5 '>  
            <img className="w-full h-[30vh] m-4 rounded-xl" src={image} alt="Image for the content" />
