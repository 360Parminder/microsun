...
const Contactus=()=>{
    return(
        <>
        <div className="flex flex-col items-center text-center w-screen text-slate-800 bg-fixed ">
            ...
            <div className="flex flex-col items-center md:items-start md:flex-row mt-10 md:mt-24 gap-10 md:justify-around">
                <div className="w-11/12 md:w-5/12 " >
                    <h4 className="text-lg md:text-4xl font-normal">We are microsun and we are here to serve! How can we help you?</h4>
                ...
                <div className="w-11/12 md:w-5/12 mb-10"> 
                    ...
                    <input className="h-10 rounded-md text-xl ps-2 text-fixed " id="name" type="text" />
                    <label htmlFor="email">Email </label>
                    <input className="h-10 rounded-md text-xl ps-2 text-fixed " id="email" type="text" />
