...
const Footer=()=>{
    return(
        ...
        <div className=" relative w-full mt-10  bg-footer bg-cover bg-no-repeat bg-center rounded-md text-white ">
            ...
            <div className=" sm:w-11/12 md:w-1/5"><img src="/image/microsun.png" alt="Microsun Logo" /></div>
            ...
            <div className=" flex flex-col md:w-4/12 mt-5 md:mt-1 items-center">
                ...
                <input className="h-10 rounded-md text-base md:text-lg ps-2 " type="text" /><button className="py-2 px-3 bg-black text-cyan-50 rounded-md">Submit</button>
                </div>
